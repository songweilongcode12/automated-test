...
async function radiocontrol(driver, webdriver,params){
  const {
    By,
    until,
  }=webdriver;
  try {
    ...
    const start = await driver.findElement(By.xpath("//div[@class='bg-c-editor-formview-components-node-source'][contains(.,'单选框')]"));
    ...
    // }else{
    //   console.info('复选框控件属性不可见设置失败')
    // }
    await driver.wait(until.elementLocated(By.xpath("(//input[contains(@type,'checkbox')])[1]")),2000).click();
    await driver.wait(until.elementLocated(By.xpath("(//input[contains(@type,'checkbox')])[2]")),2000).click();
    await driver.sleep(3000);
    const controltext = await driver.findElement(By.xpath("//span[contains(text(),'Radio - 单选框')]")).getText();
    await driver.sleep(3000)
    ...
    await driver.wait(until.elementLocated(By.xpath("(//input[contains(@type,'checkbox')])[4]"))).click();
    await driver.sleep(3000);
    const labname = await driver.wait(until.elementLocated(By.xpath("//input[contains(@value,'Radio')]")),4000);
    await labname.sendKeys(input.Key.COMMAND,'a');
    await labname.sendKeys(input.Key.DIVIDE);
    // await driver.sleep(9000);
    await driver.wait(until.elementLocated(By.xpath("//input[contains(@value,'Radio')]")),2000).sendKeys(publicdata.controlname)
    ...
    await driver.sleep(2000);
    await driver.wait(until.elementLocated(By.xpath("(//input[contains(@type,'text')])[5]")),2000).sendKeys('1');
    await driver.sleep(3000);
    ...
    await driver.sleep(3000);
    await newdata.newdata(driver,webdriver,'C',"//input[@type='radio' and @value='1']","//input[@type='radio' and @value='2']");
    await editdata.editdata(driver,webdriver,'A',"//input[@type='radio' and @value='2']");
