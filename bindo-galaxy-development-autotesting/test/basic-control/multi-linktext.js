...
async function multilinktext(driver, webdriver,params){
  const {
    By,
    until,
  }=webdriver;
  try {
    ...
    await newdata.newdata(driver,webdriver,'B',"//textarea[@data-__meta='[object Object]']");
    await editdata.editdata(driver,webdriver,'B',"//textarea[@data-__meta='[object Object]']");
